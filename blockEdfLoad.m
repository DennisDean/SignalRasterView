...
% Opertion Flags
RETURN_PHYSICAL_VALUES = 1;   % Only if signals are loaded
SWAP_MIN_MAX = 1;             % Only if signals are loaded
...
if nargout >=3
    ...
    for s = 1:num_signals
        ...
        if and((SWAP_MIN_MAX == 1), dig_max < dig_min) 
        ...
        if and((SWAP_MIN_MAX == 1), phy_max < phy_min) 
